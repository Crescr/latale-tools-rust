...
<div class="app-shell">
  <aside class="sidebar">
    ...
    <div class="sidebar-bottom">
      ...
      <div class="version">v0.0.4 · 桌面版</div>
    </div>
  </aside>
    ...
    <section class="content">
      ...
      {:else}
        <div class="settings-layout">
          <div class="settings-card"><Wrench size={24} /><h3>LaTale Tools</h3><p>SPF、LDT 和 STG 资源工具。</p><div class="about-list"><span>版本<strong>0.0.4</strong></span><span>支持格式<strong>SPF / LDT / STG</strong></span><span>文件处理<strong>仅限本机</strong></span></div></div>
